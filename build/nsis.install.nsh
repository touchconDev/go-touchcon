Name "gtc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/Touchcon/go-touchconcoin/issues"
!define UPDATEURL "https://github.com/Touchcon/go-touchconcoin/releases"
!define ABOUTURL "https://github.com/Touchcon/go-touchconcoin#ethereum-go"
...
Section "GTC" GTC_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gtc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gtc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "GTC incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GTC outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GTC UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "GTC incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gtc.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "GTC outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gtc.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "GTC UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gtc.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gtc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gtc.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GTC_IDX}
    SectionGetSize ${GTC_IDX} $0
