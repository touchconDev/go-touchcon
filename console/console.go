...
import (
	...
	"github.com/touchconDev/go-touchcon/internal/jsre"
	"github.com/touchconDev/go-touchcon/internal/web3ext"
...
// Welcome show summary of current GTC instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic GTC metadata
	fmt.Fprintf(c.printer, "Welcome to the GTC JavaScript console!\n\n")
	c.jsre.Run(`
