...
import (
	...
	"github.com/touchconDev/go-touchcon/consensus/clique"
	"github.com/touchconDev/go-touchcon/consensus/ethash"
	...
	"github.com/touchconDev/go-touchcon/dashboard"
	"github.com/touchconDev/go-touchcon/eth"
	...
	"github.com/touchconDev/go-touchcon/ethstats"
	"github.com/touchconDev/go-touchcon/les"
	...
	"github.com/touchconDev/go-touchcon/p2p/nat"
	"github.com/touchconDev/go-touchcon/p2p/netutil"
	"github.com/touchconDev/go-touchcon/params"
	whisper "github.com/touchconDev/go-touchcon/whisper/whisperv5"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 42757=Touchcon)",
...
// for GTC and returns half of the allowance to assign to the database.
...
// new format.
//
// e.g. gtc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gtc --keystore /tmp/mykeystore --lightkdf account new
//
