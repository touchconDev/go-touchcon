...
import (
	...
	bzzapi "github.com/touchconDev/go-touchcon/swarm/api"
...
var (
	...
	SwarmNetworkIdFlag = cli.IntFlag{
		Name:  "bzznetworkid",
		Usage: "Network identifier (integer, default 42757=swarm Touchcon testnet)",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		...
		Value: node.DefaultIPCEndpoint("gtc"),
	}
...
// This init function sets defaults so cmd/swarm can run alongside gtc.
func init() {
