...
import (
	...
	"github.com/touchconDev/go-touchcon/light"
	...
	rpc "github.com/touchconDev/go-touchcon/rpc"
)
...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightEthereum, error) {
	...
	log.Info("Initialised chain configuration les/backend", "config", chainConfig)
